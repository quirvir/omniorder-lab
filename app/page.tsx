...
export default function Home() {
  ...
  return <main>
    ...
    <nav className="app-navigation" aria-label="Secciones de OmniOrder"><a className="active" href="#orden">1. Orden</a><a href="#canales">2. Canales</a><a href="#pagos">3. Pagos</a><a href="#operacion">4. Operación</a><a href="/admin#logs">5. Logs</a><a href="/admin#parametros">6. Parametrización</a></nav>
